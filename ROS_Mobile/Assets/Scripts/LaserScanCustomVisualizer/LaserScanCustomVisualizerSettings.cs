...
[CreateAssetMenu(fileName = "LaserScanCustomVisualizerSettings", menuName = "Robotics/Sensor Visualizers/MyLaserScan", order = 1)]
public class LaserScanCustomVisualizerSettings : VisualizerSettingsGeneric<LaserScanMsg>
{
    [SerializeField]
    ...
    public override void Draw(Drawing3d drawing, LaserScanMsg message, MessageMetadata meta)
    {
        ...
        for (int i = 0; i < message.ranges.Length; i++)
        {
            ...
            //point += Robot.Instance.Robot3DModel.transform.position;
