...
public class PointCloud2CustomVisualizerEditor : SettingsBasedVisualizerEditor<PointCloud2Msg, PointCloud2CustomVisualizerSettings>
{
    public override void OnInspectorGUI()
    {
        ...
        {
            m_Config.ColorModeSetting = (PointCloud2CustomVisualizerSettings.ColorMode)EditorGUILayout.EnumPopup("Color mode", m_Config.ColorModeSetting);

            switch (m_Config.ColorModeSetting)
            {
                case PointCloud2CustomVisualizerSettings.ColorMode.HSV:
                    ...
                    break;
                case PointCloud2CustomVisualizerSettings.ColorMode.CombinedRGB:
                    CreateNewDropdown(m_Config.Channels, "Rgb channel name:", m_Config.RgbChannel, newChannel => { m_Config.RgbChannel = newChannel; });
                    break;
                case PointCloud2CustomVisualizerSettings.ColorMode.SeparateRGB:
