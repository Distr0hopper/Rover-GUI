...
[CreateAssetMenu(fileName = "myPointCloud2VisualizerSettings", menuName = "Robotics/Sensor Visualizers/myPointCloud2", order = 1)]
public class myPointCloud2VisualizerSettings : VisualizerSettingsGeneric<PointCloud2Msg>
{
    ...
    public override void Draw(Drawing3d drawing, PointCloud2Msg message, MessageMetadata meta)
    {
       ...
       var pointCloud = drawing.AddPointCloud((int)(message.data.Length / message.point_step));
        ...
        for (int i = 0; i < maxI; i++)
        {
            ...
            //Debug.Log(timedPoints.Count);
            //pointCloud.AddPoint(timedPoint.unityPoint, color, radius);
        }
